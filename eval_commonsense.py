...
# -*- coding: utf-8 -*-
"""
Evaluate on (Chinese) ConceptNet World Knowledge
...
def create_dataset(test_path, tokenizer):
...
def main():
    ...
    # io options    
    parser.add_argument("--data_path", type=str, default="./data/knowledge/commonsense.txt")
